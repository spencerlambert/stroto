...
//    clientID = @"283801024967-4j8ngk615ogc46qnj2a21gpgss11iudd.apps.googleusercontent.com";
//    clientSecret = @"t4Aj8LeYJJVfe2vw52RkJJuk";
...
//    NSString *path = [_uploadPathField stringValue];
    ...
    path = [path stringByAppendingString:[NSString stringWithFormat:@"/mov_dir/%d.mov",1] ];
